...
export default function QuoteOfTheDay() {
	...
	const [quote, setQuote] = useState("The universe is made of stories, not of atoms.");
	...
	// 			setBackgroundQuote(data.contents.quotes[0].background);
	// 			console.log(data);
	// 		} catch (err) {
	// 			console.log(err);
	// 		}
			...
			>
				...
				<Box>
					...
					<Typography variant="h6">
						Welcome To Taskopia Task Manager
					</Typography>
				</Box>
			</Box>
